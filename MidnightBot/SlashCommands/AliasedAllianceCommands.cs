...
namespace MidnightBot.SlashCommands
{
    ...
    public class AliasedAllianceCommands : ApplicationCommandModule
    {
        ...
        {
            await new AllianceCommands().AllianceInfoCommand(ctx, searchValue);
        }
        ...
        {
            await new AllianceCommands().AllianceBalCommand(ctx, searchValue);
        }
        ...
        {
            await new AllianceCommands().AllianceAPCommand(ctx, searchValue);
        }
        ...
        {
            await new AllianceCommands().AllianceRealmPointsCommand(ctx, searchValue, realmType);
        }
    }
}
